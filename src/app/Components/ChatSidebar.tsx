...
interface ChatSidebarProps {
  ...
  onTabChange?: (tab: 'chats' | 'settings' | 'profile') => void;
}
  ...
  return (
    <div className="chat-sidebar">
      ...
      <div className="sidebar-top">
        <button
          className={`sidebar-icon-button ${activeTab === 'chats' ? 'active' : ''}`}
          onClick={() => handleTabClick('chats')}
          onMouseEnter={() => setHoveredItem('chats')}
          onMouseLeave={() => setHoveredItem(null)}
          title="Chats"
        >
          <div className={`sidebar-icon-wrapper ${hoveredItem === 'chats' || activeTab === 'chats' ? 'hovered' : ''}`}>
            {/* Chat Icon */}
      ...
      <div className="sidebar-bottom">
        <button
          className={`sidebar-icon-button ${activeTab === 'settings' ? 'active' : ''}`}
          onClick={() => handleTabClick('settings')}
          onMouseEnter={() => setHoveredItem('settings')}
          onMouseLeave={() => setHoveredItem(null)}
          title="Settings"
        >
          <div className={`sidebar-icon-wrapper ${hoveredItem === 'settings' || activeTab === 'settings' ? 'hovered' : ''}`}>
            {/* Settings Icon */}
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button
          className={`sidebar-icon-button ${activeTab === 'profile' ? 'active' : ''}`}
        ...
        <button
          ...
          title="Logout"
        >
          <div className={`sidebar-icon-wrapper ${hoveredItem === 'logout' ? 'hovered' : ''}`}>
            {/* Logout Icon */}
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
